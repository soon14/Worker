...
public interface UserApi {
    ...
    @FormUrlEncoded
    @POST("user/help-reg")
    Observable<BaseResponse<MessageBean>> helpReg(@Field("mobile")String mobile,@Field("code")String code,@Field("name")String name,@Field("idCard")String idCard,@Field("wtIds")String wtIds );
