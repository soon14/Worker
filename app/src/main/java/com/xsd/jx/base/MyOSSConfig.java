...
public class MyOSSConfig {
    ...
    public static final String OSS_INTERNAL_ENDPOINT = "http://oss-cn-shenzhen-internal.aliyuncs.com";
    //callback 测试地址
    public static final String OSS_CALLBACK_URL = "http://oss-demo.aliyuncs.com:23450";
    //'vpcEndPoint' => 'oss-cn-shenzhen-internal.aliyuncs.com',
    // STS 鉴权服务器地址。
    // 或者根据工程sts_local_server目录中本地鉴权服务脚本代码启动本地STS鉴权服务器。
    public static final String STS_SERVER_URL = "http://****/sts/getsts";//STS 地址

    public static final String BUCKET_NAME = "yuemeoss";
    public static final String OSS_ACCESS_KEY_ID = "LTAI4GFn6nTKd1bYFSb1XLdK";
    public static final String OSS_ACCESS_KEY_SECRET = "3216V9vIs0utqQEA3wD7xzVk1y793R";
